...
const unsigned char bitmaps[16][8] PROGMEM = {
	{ 0xc3, 0xc3, 0x00, 0x18, 0x18, 0x81, 0xff, 0x7e }, // 0.smiley 3 small
	{ 0x3c, 0x42, 0x81, 0x81, 0xc3, 0x24, 0xa5, 0xe7 }, // 1.Omega
	{ 0x81, 0x42, 0x24, 0x18, 0x18, 0x24, 0x42, 0x81 }, // 2.X
	{ 0xBD, 0xA1, 0xA1, 0xB9, 0xA1, 0xA1, 0xA1, 0x00 }, // 3.ifi
	{ 0xEF, 0x48, 0x4B, 0x49, 0x4F, 0x00, 0x00, 0x00 }, // 4.TG
	{ 0x38, 0x7f, 0xE6, 0xC0, 0xE6, 0x7f, 0x38, 0x00 }, // 5.Commodore symbol
	{ 0x00, 0x22, 0x77, 0x7f, 0x3e, 0x3e, 0x1c, 0x08 }, // 6.Heart
	{ 0x1C, 0x22, 0x55, 0x49, 0x5d, 0x22, 0x1c, 0x00 }, // 7.face
	{ 0x37, 0x42, 0x22, 0x12, 0x62, 0x00, 0x7f, 0x00 }, // 8.ST
	{ 0x89, 0x4A, 0x2c, 0xF8, 0x1F, 0x34, 0x52, 0x91 }, // 9.STAR
	{ 0x18, 0x3c, 0x7e, 0xdb, 0xff, 0x24, 0x5a, 0xa5 }, // 10.Space Invader
	{ 0x00, 0x9c, 0xa2, 0xc5, 0xc1, 0xa2, 0x9c, 0x00 }, // 11.Fish
	{ 0x00, 0x08, 0x1C, 0x3E, 0x7F, 0x1C, 0x1C, 0x1C }, // 12.Up-Arrow
	{ 0x00, 0x1C, 0x1C, 0x1C, 0x7F, 0x3E, 0x1C, 0x08 }, // 13.Down-Arrow
	{ 0x00, 0x08, 0x18, 0x3F, 0x7F, 0x3F, 0x18, 0x08 }, // 14.Left-Arrow
	{ 0x00, 0x08, 0x0C, 0x7E, 0x7F, 0x7E, 0x0C, 0x08 }  // 15.Right-Arrow
};
...
unsigned char font_getbitmappixel ( char bitmap, char x, char y)
{
	uint8_t tmp = //eeprom_read_byte((uint8_t*)&bitmaps[(uint8_t)bitmap][(uint8_t)x]);
		pgm_read_byte(&bitmaps[(uint_fast8_t)bitmap][(uint_fast8_t)x]);
		//bitmaps[(uint8_t)bitmap][(uint8_t)x];
	return (tmp >> y) & 0x01;
}
